...
use crate::{
    utils::{
        IpcHandler, NewWindowFeatures, NewWindowOpener, NewWindowResponse, WebContext,
        WebViewMetaData, WebviewBounds, WebviewIpcHandler,
        events::{DownloadEvent, DragDropEvent, PageLoadEvent, SynthesizedEvent},
        parse_proxy_url,
...
pub(crate) fn create_wry_webview(
    ...
    if webview_attributes.use_https_scheme {
